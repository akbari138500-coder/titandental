...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-clinical-light dark:bg-clinical-dark flex items-center justify-center px-4 py-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <User className="absolute right-3 top-1/2 -translate-y-1/2 h-4 w-4 text-clinical-navy/40 dark:text-white/30" />
                <input
                  type="text"
                  id="name"
                  value={name}
            ...
            <div className="space-y-1.5">
              ...
              {password.length > 0 && (
                <div className={`flex items-center gap-1.5 text-xs mt-1 ${passwordStrong ? "text-clinical-green" : "text-amber-500"}`}>
                  <CheckCircle className="h-3.5 w-3.5" />
                  {passwordStrong ? "رمز عبور قوی است" : "رمز عبور باید حداقل ۸ کاراکتر باشد"}
                </div>
              )}
            </div>
